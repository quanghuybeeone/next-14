...
export default function ThemeToggleMode() {
  ...
  return (
    <>
      <button
        onClick={toggleTheme}
        className="p-1 w-[36px] h-[36px] rounded-full bg-foreground text-background absolute top-1/2  right-0 translate-y-[-50%]"
      >
        {theme === "dark" ? "☀️" : "🌙"}
      </button>
      {/* <button
        aria-label="theme toggler"
        className="flex h-11 w-11 items-center justify-center rounded-lg bg-white text-dark-4 duration-300 hover:bg-stroke dark:bg-dark-2 dark:text-white dark:hover:bg-dark-3 sm:flex"
      >
        <span>
          <svg
            width={24}
